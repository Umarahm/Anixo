      ...
      >
        <div className="flex items-center gap-4 sm:gap-6 lg:gap-10">
          ...
          >
            ...
            <span className={`text-[9px] sm:text-[12px] font-medium ${autoNext ? 'text-white' : 'text-white/60'}`}>{t('player.autoNext')}</span>
          </button>
          ...
          >
            ...
            <span className={`text-[9px] sm:text-[12px] font-medium ${autoPlay ? 'text-white' : 'text-white/60'}`}>{t('player.autoPlay')}</span>
          </button>
        </div>
